...
const CShtulpovoeWindowRightMain = ({width, height, setHeight, setWidth, left, setLeft, setRight, right}) => {
    ...
    return (
        <div style={{
            ...
            >
                ...
                <rect x="-0.1" y="0.1" width="3.8" height="7.8" transform="matrix(-1 0 0 1 72.8 65)" fill="white"
                      stroke="black" strokeWidth="0.2"/>
                <rect x="-0.12" y="0.12" width="1.76" height="7.76" transform="matrix(-1 0 0 1 71.76 69)" fill="white"
                      stroke="black" strokeWidth="0.24"/>
                <rect x="-0.1" y="0.1" width="3.8" height="7.8" transform="matrix(-1 0 0 1 62.8 65)" fill="white"
                      stroke="black" strokeWidth="0.2"/>
                <rect x="-0.12" y="0.12" width="1.76" height="7.76" transform="matrix(-1 0 0 1 61.76 69)" fill="white"
                      stroke="black" strokeWidth="0.24"/>
                ...
                <path
                    d="M150.646 141.357C150.842 141.552 151.158 141.552 151.354 141.357L154.536 138.175C154.731 137.98 154.731 137.663 154.536 137.468C154.34 137.273 154.024 137.273 153.828 137.468L151 140.296L148.172 137.468C147.976 137.273 147.66 137.273 147.464 137.468C147.269 137.663 147.269 137.98 147.464 138.175L150.646 141.357ZM151.354 0.646454C151.158 0.451187 150.842 0.451187 150.646 0.646454L147.464 3.82843C147.269 4.0237 147.269 4.34027 147.464 4.53554C147.66 4.73079 147.976 4.73079 148.172 4.53554L151 1.70711L153.828 4.53554C154.024 4.73079 154.34 4.73079 154.536 4.53554C154.731 4.34027 154.731 4.0237 154.536 3.82843L151.354 0.646454ZM151.5 141.004L151.5 1H150.5L150.5 141.004H151.5Z"
                    fill="black"/>
                <path
                    d="M0.646447 180.646C0.451184 180.842 0.451184 181.158 0.646447 181.354L3.82843 184.536C4.02369 184.731 4.34027 184.731 4.53553 184.536C4.7308 184.34 4.7308 184.024 4.53553 183.828L1.70711 181L4.53553 178.172C4.7308 177.976 4.7308 177.66 4.53553 177.464C4.34027 177.269 4.02369 177.269 3.82843 177.464L0.646447 180.646ZM131.354 181.354C131.549 181.158 131.549 180.842 131.354 180.646L128.172 177.464C127.976 177.269 127.66 177.269 127.464 177.464C127.269 177.66 127.269 177.976 127.464 178.172L130.293 181L127.464 183.828C127.269 184.024 127.269 184.34 127.464 184.536C127.66 184.731 127.976 184.731 128.172 184.536L131.354 181.354ZM1 181.5H131V180.5H1V181.5Z"
                    fill="black"/>
                <path
                    d="M0.646447 160.646C0.451184 160.842 0.451184 161.158 0.646447 161.354L3.82843 164.536C4.02369 164.731 4.34027 164.731 4.53553 164.536C4.7308 164.34 4.7308 164.024 4.53553 163.828L1.70711 161L4.53553 158.172C4.7308 157.976 4.7308 157.66 4.53553 157.464C4.34027 157.269 4.02369 157.269 3.82843 157.464L0.646447 160.646ZM66.3536 161.354C66.5488 161.158 66.5488 160.842 66.3536 160.646L63.1716 157.464C62.9763 157.269 62.6597 157.269 62.4645 157.464C62.2692 157.66 62.2692 157.976 62.4645 158.172L65.2929 161L62.4645 163.828C62.2692 164.024 62.2692 164.34 62.4645 164.536C62.6597 164.731 62.9763 164.731 63.1716 164.536L66.3536 161.354ZM1 161.5L66 161.5V160.5L1 160.5L1 161.5Z"
                    fill="black"/>
                <path
                    d="M65.6464 160.646C65.4512 160.842 65.4512 161.158 65.6464 161.354L68.8284 164.536C69.0237 164.731 69.3403 164.731 69.5355 164.536C69.7308 164.34 69.7308 164.024 69.5355 163.828L66.7071 161L69.5355 158.172C69.7308 157.976 69.7308 157.66 69.5355 157.464C69.3403 157.269 69.0237 157.269 68.8284 157.464L65.6464 160.646ZM131.354 161.354C131.549 161.158 131.549 160.842 131.354 160.646L128.172 157.464C127.976 157.269 127.66 157.269 127.464 157.464C127.269 157.66 127.269 157.976 127.464 158.172L130.293 161L127.464 163.828C127.269 164.024 127.269 164.34 127.464 164.536C127.66 164.731 127.976 164.731 128.172 164.536L131.354 161.354ZM66 161.5L131 161.5V160.5L66 160.5V161.5Z"
                    fill="black"/>
            </svg>
...
export default CShtulpovoeWindowRightMain;
